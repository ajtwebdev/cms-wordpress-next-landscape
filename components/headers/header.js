...
`;
const LinkDark = styled((props) => <Link {...props} />)`
  text-decoration: none;
  text-transform: uppercase;
  font-size: var(--fs-sm);
  font-weight: var(--fw-700);
            ...
            <Nav>
              ...
              <NavList nav={nav}>
                <Dropdown>
                  ...
                  <div>
                    <ul>
                      <LinkDark href="/residential-services/hardscaping">
                ...
                <Dropdown>
                  ...
                  <div>
                    <ul>
                      <LinkDark className="subheader accent" href="/about">
                ...
                <li>
                  <StyledNavLink href="/commercial-services">
                    commercial services
                  </StyledNavLink>
                </li>
                <li>
